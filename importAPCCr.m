function [V,J,Pe,Ct1,Cp1,PWR,Torque,Thrust,VarName9] = importAPCCr(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [V,J,PE,CT1,CP1,PWR,TORQUE,THRUST,VARNAME9] = IMPORTFILE(FILENAME)
...
%
% Example:
%   [V,J,Pe,Ct1,Cp1,PWR,Torque,Thrust,VarName9] = importfile('16x7E.txt',17, 457);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/03/02 00:37:21
...
rawNumericColumns(I,:) = [];
rawStringColumns(I,:) = [];
rowNum=size(rawNumericColumns(:, 1));
%% Allocate imported array to column variable names
V = cell2mat(rawNumericColumns(:, 1));
J = cell2mat(rawNumericColumns(:, 2));
Pe = cell2mat(rawNumericColumns(:, 3));
Ct1 = cell2mat(rawNumericColumns(:, 4));
Cp1 = cell2mat(rawNumericColumns(:, 5));
PWR = cell2mat(rawNumericColumns(:, 6));
Torque = cell2mat(rawNumericColumns(:, 7));
Thrust = cell2mat(rawNumericColumns(:, 8));
VarName9 = rawStringColumns(:, 1);
