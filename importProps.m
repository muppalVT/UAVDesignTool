function [PropNames,pSave] = importProps(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [PROPNAMES,PSAVE] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [PROPNAMES,PSAVE] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [PropNames,pSave] = importfile('Props.txt',1, 316);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/05/09 10:46:55
...
PropNames = rawStringColumns(:, 1);
pSave = rawStringColumns(:, 2);
